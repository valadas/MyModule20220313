...
internal class Build : NukeBuild
{
    ...
    private const string prodViewsPath = "/DesktopModules/MyModule20220313/resources/scripts/era-mymodule/";
    ...
    Target GenerateReleaseNotes => _ => _
        ...
        .Executes(() =>
        {
            try
            {
                ...
                var milestone = allMilestones.Where(m => m.Title == GitVersion.MajorMinorPatch).FirstOrDefault();
